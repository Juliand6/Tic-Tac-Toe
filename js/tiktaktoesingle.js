...
var temp = document.querySelector(".temperature p");
var condition = document.querySelector(".weather_condition p");
var location = document.querySelector(".location p");


//sees if browser supports geolocation, if not send error message
